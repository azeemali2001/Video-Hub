  ...
  return (
    <Stack direction={['column', 'row']} h={'100vh'}>
        <VStack w={'full'}>
            ...
            <VStack alignItems={'flex-start'} p={'3'} w={'full'} overflow={'auto'}>
                <Heading>Sample Video 1</Heading>
                <Text>This is Sample Video for Learning React.js</Text>
            </VStack>
        ...
        {videosArr.map((item, idx)=> (
            <Button variant={'ghost'} colorScheme='purple' onClick={() => setvideoSrc(item)}>Lecture {idx + 1}</Button>
        ))}
